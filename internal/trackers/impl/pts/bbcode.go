...
func finalizeDescription(value string) string {
	...
	value = strings.NewReplacer(
		"[user]", "", "[/user]", "", "[align=left]", "", "[/align]", "", "[right]", "", "[/right]", "", "[align=right]", "", "[/align=right]", "", "[sup]", "", "[/sup]", "", "[sub]", "", "[/sub]", "", "[alert]", "", "[/alert]", "", "[note]", "", "[/note]", "", "[hr]", "", "[/hr]", "",
		"[h1]", "[u][b]", "[/h1]", "[/b][/u]", "[h2]", "[u][b]", "[/h2]", "[/b][/u]", "[h3]", "[u][b]", "[/h3]", "[/b][/u]", "[ul]", "", "[/ul]", "", "[ol]", "", "[/ol]", "", "[hide]", "", "[/hide]", "",
	).Replace(value)
