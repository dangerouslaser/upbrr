...
func (s *claimChecker) HasClaim(ctx context.Context, meta api.PreparedMetadata) (bool, error) {
...
func (s *claimChecker) FailureReason(meta api.PreparedMetadata) string {
...
func btnIsTVCategory(meta api.PreparedMetadata) bool {
	return meta.HasTVSeasonEpisodeSignal() || meta.TVPack || strings.TrimSpace(meta.DailyEpisodeDate) != ""
}
...
func ClaimWindowExpired(meta api.PreparedMetadata, graceHours int) (bool, int, float64) {
